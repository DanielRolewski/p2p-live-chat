...
<head>
    ...
    @vite(['resources/css/show-chat.css', 'resources/js/app.js'])
</head>
<body>
    <nav>
        <svg class="logo" width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <filter id="filter0_ii_28_78" x="-3" y="-10" width="59" height="69" filterUnits="userSpaceOnUse"
    ...
    <main>
        <div class="window">
            <div class="form-container" id="chatroom">
                <div class="banner">
                    <span>live chat</span>
                    <hr>
                </div>
